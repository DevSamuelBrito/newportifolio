...
export const ProjectsData: Project[] = [
  {
    ...
    descriptionBr: [
      "Este projeto foi uma simples landing page criada para uma empresa de manutenção especializada em bebedouros. A página foi desenvolvida utilizando HTML e CSS, com o objetivo de fornecer uma presença online limpa e profissional para o negócio. O design foca em destacar os serviços da empresa, informações de contato e um call to action para que potenciais clientes entrem em contato. Este projeto foi uma oportunidade para praticar habilidades básicas de desenvolvimento web e criar um site funcional para um negócio local.",
    ],
    descriptionEn: [
      "This project was a simple landing page created for a maintenance company specializing in drinking fountains. The page was developed using HTML and CSS, with the goal of providing a clean and professional online presence for the business. The design focuses on showcasing the company services, contact information, and a call to action for potential customers to get in touch. This project was an opportunity to practice basic web development skills and create a functional website for a local business.",
    ],
  },
  {
    id: "crudAspNet",
