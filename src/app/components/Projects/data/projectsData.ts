...
export const ProjectsData: Project[] = [
  {
    ...
    descriptionBr: [
      ...
      "- 🚀 Alta Performance: Geração de Site Estático (SSG) utilizando o App Router do Next.js para carregamento praticamente instantâneo.",
      "- 🔍 SEO Avançado: Estrutura HTML5 semântica, metadados globais bem definidos (Open Graph) e hierarquia correta de títulos garantindo excelente indexação nos motores de busca.",
      "- ♿ Acessibilidade (A11y): Implementação de tags nativas (como <details> e <summary> para o FAQ), contraste adequado de cores e navegação totalmente acessível por teclado.",
      "- 📱 Design System Responsivo: Abordagem Mobile First com Tailwind CSS v4 para uma adaptação perfeita em smartphones, tablets e desktops.",
      "O projeto demonstra um excelente domínio de arquitetura baseada em componentes, Clean Code e tipagem estrita com TypeScript, resultando em um código modular, seguro e altamente escalável.",
    ],
    descriptionEn: [
      "The Maintenance Drinking Fountains Landing Page is a project developed to establish a strong, professional, and modern online presence for a company specializing in drinking fountain maintenance.",
      "This Single-Page Application (SPA) was built with a focus on high performance, optimized SEO, and an excellent user experience (UX), ensuring smooth navigation and efficiently driving visitors to convert into leads.",
      "✨ Main Features and Highlights",
      "- 🚀 High Performance: Static Site Generation (SSG) using the Next.js App Router for near-instant load times.",
      "- 🔍 Advanced SEO: Semantic HTML5 structure, well-defined global metadata (Open Graph), and correct heading hierarchy ensuring excellent search engine indexing.",
      "- ♿ Accessibility (A11y): Implementation of native tags (such as <details> and <summary> for the FAQ), adequate color contrast, and fully keyboard-accessible navigation.",
      "- 📱 Responsive Design System: Mobile First approach utilizing Tailwind CSS v4 for perfect adaptation across smartphones, tablets, and desktops.",
      "The project demonstrates an excellent mastery of component-based architecture, Clean Code, and strict typing with TypeScript, resulting in modular, secure, and highly scalable code.",
    ],
  },
  {
    id: "crudAspNet",
    ...
    descriptionBr: [
      ...
      " ✨ Funcionalidades Principais - CRUD completo de tarefas (Create, Read, Update, Delete) - Sistema de paginação com filtros por título e status - Tratamento global de exceções com respostas padronizadas - Rate limiting (limitação de requisições por IP) - Logging estruturado com ILogger - Documentação automática com Swagger/OpenAPI",
      " 🚀 Tecnologias e Ferramentas - Entity Framework Core 9.0 com PostgreSQL - Docker e Docker Compose para containerização - Migrações automáticas no startup - Testes unitários com xUnit - CI/CD com GitHub Actions - CORS configurado para integração com frontend",
    ...
    descriptionEn: [
      "Study project of a complete RESTful API for task management built with ASP.NET Core 9.0, following Clean Architecture principles and development best practices. This project was created to deepen knowledge in software architecture and back-end development with .NET.",
      "🏗️ Architecture and Patterns - Clean Architecture with well-separated layers (API, Application, Domain, Infrastructure) - DTOs for separation of concerns - Repository Pattern for data access - AutoMapper for object mapping - Automatic validation with Data Annotations",
      "  ✨ Main Features - Complete CRUD operations for tasks (Create, Read, Update, Delete) - Pagination system with filters by title and status - Global exception handling with standardized responses - Rate limiting (request limitation per IP) - Structured logging with ILogger - Automatic documentation with Swagger/OpenAPI",
      " 🚀 Technologies and Tools  - Entity Framework Core 9.0 with PostgreSQL - Docker and Docker Compose for containerization - Automatic migrations on startup - Unit tests with xUnit - CI/CD with GitHub Actions - CORS configured for frontend integration",
  ...
  },
  {
    ...
    descriptionEn: [
      "Portifol.io is a complete application developed in Next.js that demonstrates a authentication and image management system.",
      "This study project was created to deepen knowledge in Next.js (App Router and API Routes), integration with external services, and state management.",
      "Main Features:",
  ...
  },
  {
    ...
    descriptionEn: [
      "This portfolio was created to showcase my skills as a full-stack developer, focusing on modern technologies such as Next.js, TypeScript, Tailwind CSS and Framer-Motion.",
      "Throughout the development, I used reusable components, interactive animations and responsive design to ensure a great user experience, whether on desktop or mobile devices.",
  ...
  },
  {
    ...
    descriptionEn: [
      "Dev_Controle is a full-stack application developed with Next.js for user and ticket management.",
  ...
  },
  {
    ...
    descriptionEn: [
      "DevMotors is a project developed for a workshop specializing in car maintenance, located in São Paulo.",
      "This website was built using Next.js and other modern technologies, ensuring a fast, responsive and optimized application.",
      "Unlike a static website, DevMotors consumes information directly from Cosmic JS, a headless CMS that allows you to manage the website content dynamically, without having to modify the code.",
      "Main Features:",
  ...
  },
  {
    ...
    descriptionBr: [
      ...
      "Algumas das principais funcionalidades incluem pesquisa de jogos, exibição de um jogo do dia e a possibilidade de favoritar títulos no perfil do usuário.",
      "Durante o desenvolvimento, foquei na criação de componentes reutilizáveis e no uso de renderização server-side e client-side para otimizar a experiência do usuário.",
    ],
    descriptionEn: [
      "DalyGames is a web application developed with Next.js for exploring and managing games.",
      "The project uses a REST API to display game details, including title, description, image, platforms, and categories.",
      "Some of the main features include searching for games, displaying a game of the day, and the ability to favorite titles on the user's profile.",
      "During development, I focused on creating reusable components and using server-side and client-side rendering to optimize the user experience.",
      "This project was a great opportunity to improve my knowledge of Next.js, TypeScript, REST APIs, and Tailwind CSS.",
    ],
  },
  {
    id: "tarefasNextJs",
    ...
    descriptionBr: [
      ...
      "Caso um usuário queira interagir com tarefas compartilhadas, ele também precisa estar autenticado.",
      "O sistema conta com um painel de controle, onde os usuários podem gerenciar suas tarefas e definir se elas serão públicas ou privadas.",
      "Além disso, implementei endpoints para gerenciar tarefas e comentários, utilizando Firebase para armazenar os dados.",
      "Esse projeto foi uma ótima oportunidade para aprofundar meus conhecimentos em Next.js, autenticação com NextAuth e integração com Firebase.",
    ],
    descriptionEn: [
      "This project is a To-Do List application developed with Next.js, focused on task management and sharing.",
      "Authentication is done via Google using NextAuth, allowing users to create, edit and share tasks with others.",
      "If a user wants to interact with shared tasks, he/she also needs to be authenticated.",
      "The system has a control panel, where users can manage their tasks and define whether they are public or private.",
      "In addition, I implemented endpoints to manage tasks and comments, using Firebase to store the data.",
      "This project was a great opportunity to deepen my knowledge of Next.js, authentication with NextAuth and integration with Firebase.",
    ],
  },
  {
    id: "webRepositorios",
    ...
    descriptionBr: [
      ...
      "O projeto utiliza o React Router para navegação entre páginas e a API do GitHub para buscar os dados em tempo real.",
      "Principais funcionalidades:",
    ...
    descriptionEn: [
      "This was my first complete project using React, created to better understand the tool and its dynamics with components, states and routes.",
      "With this application, you can search for a GitHub repository and view all open and closed issues associated with it.",
      "The project uses React Router to navigate between pages and the GitHub API to retrieve data in real time.",
      "Main features:",
  ...
  },
  {
    ...
    descriptionEn: [
      "This project was a fun way to practice JavaScript, where I developed a classic Rock, Paper, Scissors game that records the player's score against the machine.",
  ...
  },
  {
    ...
    descriptionEn: [
      "This calculator was one of my first projects when I started learning JavaScript.",
      "Developed with HTML, CSS, and JavaScript, it helped me understand fundamental concepts such as DOM manipulation, click events, and programming logic.",
  ...
  },
  {
    ...
    descriptionBr: [
      ...
      "Fiquei responsável pelo repositório do front-end, que foi integrado ao back-end, onde o site implementava um CRUD completo.",
      "O sistema permitia a criação de usuários (tanto usuários comuns quanto administradores), a escolha de produtos, a adição ao carrinho e a finalização da compra. Além disso, o sistema interagia com o banco de dados, atualizando as informações em tempo real.",
    ...
    descriptionEn: [
      "During my time at Fatec Rio Preto, I participated in a group academic project where we developed a complete website for product and user management.",
      "The project involved creating documentation, as well as developing the website using technologies such as HTML, CSS, MySQL, C#, .NET and ASP.NET to implement the MVC standard.",
      "I was responsible for the front-end repository, which was integrated with the back-end, where the website implemented a complete CRUD.",
      "The system allowed users to be created (both regular users and administrators), choose products, add them to the cart and complete the purchase. In addition, the system interacted with the database, updating the information in real time.",
  ...
  },
  {
    ...
    descriptionEn: [
      "This was my first portfolio, developed only with HTML and CSS, when I started exploring the world of web development.",
      "The goal of this project was to create a simple and structured page to present a little about myself and my first works.",
